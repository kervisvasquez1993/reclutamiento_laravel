                ...
                <div class="flex items-center justify-around">
                    ...
                    <nav class="flex-1 text-right">
                            ...
                            @guest
                                ...
                                <a class="text-white no-underline hover:no-underline hover:text-gray-300 p-3" href="{{ route('login') }}">{{ __('Login') }}</a>
                                
                                @if (Route::has('register'))
                                
                                <a class="text-white no-underline hover:no-underline hover:text-gray-300 p-3" href="{{ route('register') }}">{{ __('Register') }}</a>
