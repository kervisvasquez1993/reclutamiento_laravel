                ...
                <div class="bg-gray-300 text-gray-700 uppercase text-center py-3 px-6 mb-0">
                    ...
                    <form  class="py-10 px-5" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex flex-wrap mb-3">
                            <label for="email" class="block text-gray-700 text-sm mb-2">{{ __('Correo') }}</label>
                        ...
                        <div class="flex flex-wrap mb-0">
                                <button type="submit"
                                    class="bg-blue-500 font-bold w-full hover:bg-blue-700 p-3 text-gray-100  focus:outline-none focus:shadow-outline uppercase"
                                >
                                    {{ __('Login') }}
                                </button>
